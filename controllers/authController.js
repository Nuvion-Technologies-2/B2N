...
exports.signup = async (req, res) => {
    try {
        ...
        const decryptedBody = req.body; // Decrypt incoming data
...
console.log(req.body)
        ...
        if (password!==user.password) return res.status(400).json({ encryptedData: encryptData({ message: 'Invalid credentials' }) });
